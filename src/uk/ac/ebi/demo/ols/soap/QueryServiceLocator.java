...
public class QueryServiceLocator extends org.apache.axis.client.Service implements uk.ac.ebi.demo.ols.soap.QueryService {
    ...
    ////////////////// khaled ////////////////////////////////////////////////////////
     public uk.ac.ebi.demo.ols.soap.Query getTermByID(String termId,String ontoName) throws javax.xml.rpc.ServiceException {
       java.net.URL endpoint;
        try {
            endpoint = new java.net.URL(OntologyQuery_address);
        }
        ...
        return getTermByID(endpoint,termId,ontoName);
    }

    public uk.ac.ebi.demo.ols.soap.Query getOntologyQuery(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            uk.ac.ebi.demo.ols.soap.OntologyQuerySoapBindingStub _stub = new uk.ac.ebi.demo.ols.soap.OntologyQuerySoapBindingStub(portAddress, this);
     ...
     public uk.ac.ebi.demo.ols.soap.Query getTermByID(java.net.URL portAddress,String termId,String ontoName) throws javax.xml.rpc.ServiceException {
        try {
            uk.ac.ebi.demo.ols.soap.OntologyQuerySoapBindingStub _stub = new uk.ac.ebi.demo.ols.soap.OntologyQuerySoapBindingStub(portAddress, this);
            _stub.setPortName(getOntologyQueryWSDDServiceName());
            return _stub;
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (uk.ac.ebi.demo.ols.soap.Query.class.isAssignableFrom(serviceEndpointInterface)) {
                uk.ac.ebi.demo.ols.soap.OntologyQuerySoapBindingStub _stub = new uk.ac.ebi.demo.ols.soap.OntologyQuerySoapBindingStub(new java.net.URL(OntologyQuery_address), this);
                _stub.setPortName(getOntologyQueryWSDDServiceName());
                return _stub;
            }
        }
